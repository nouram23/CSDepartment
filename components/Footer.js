  ...
  return (
    <div className="mt-24">
      <div className="flex max-w-screen-2xl mx-auto" id="footer">
        ...
        <div className="bg-[#2A35A7] lg:w-1/2 w-full sm:rounded-t-[72px] rounded-t-[50px] -mt-40">
          <div className=" flex text-white space-x-5 ml-6 mt-6">
            <img
              ...
              alt="HureeICT"
            />
            <p className="ml-1 text-sm lg:text-xs flex flex-col justify-center">
          ...
          <div className="flex text-white m-4 sm:p-7 p-3">
            <div className="w-1/2">
              <div>
              ...
              <div className="font-light mt-6">
                <div className="font-bold sm:text-xl text-base mb-2">
                  ЦАХИМ БҮРТГЭЛ
                </div>
                <a
          ...
          <div className="flex justify-evenly mt-16  text-white sm:text-2xl text-xl">
            <a>Facebook</a>
            <a>Instagram</a>
            <a>Youtube</a>
          </div>
